...
public class SortedSetCommandTests(TestConfiguration config)
{
    ...
    public async Task TestSortedSetRangeByRankWithScoresAsync(BaseClient client)
    {
        ...
        // Test on non-existent key
        var result = await client.SortedSetRangeWithScoresAsync(key);
        Assert.Empty(result);
    ...
    public async Task TestSortedSetRangeByRank_SpecialScores(BaseClient client)
    {
        ...
        // Test with scores
        var resultWithScores = await client.SortedSetRangeWithScoresAsync(key);
    ...
    public async Task TestSortedSetRangeByScoreWithScoresAsync(BaseClient client)
    {
        ...
        result = await client.SortedSetRangeWithScoresAsync(
            key,
            new()
            {
    ...
    public async Task TestSortedSetRangeByValueAsync(BaseClient client)
    {
        ...
        // Test on non-existent key
        ValkeyValue[] result = await client.SortedSetRangeAsync(
            key,
            new()
            {
        ...
        // Test specific range
        result = await client.SortedSetRangeAsync(
            key,
            new()
            {
    ...
    public async Task TestSortedSetCombine(BaseClient client)
    {
        ...
        // Setup test data
        _ = await client.SortedSetAddAsync(
            key1,
    ...
    public async Task TestSortedSetCombineWithScores(BaseClient client)
    {
        ...
        var unionResults = await client.SortedSetUnionWithScoreAsync([key1, key2]);
        Assert.Equal(3, unionResults.Length);

        // Test intersection with scores
        var interResults = await client.SortedSetInterWithScoreAsync([key1, key2]);
        _ = Assert.Single(interResults);
        Assert.Equal(35.0, interResults[0].Score); // Sum aggregation: 20 + 15
        Assert.Equal("member2", interResults[0].Element);

        // Test with weights
        var unionWithScoreResults = await client.SortedSetUnionWithScoreAsync(new Dictionary<ValkeyKey, double> { [key1] = 2.0, [key2] = 0.5 });
        Assert.Equal(3, unionWithScoreResults.Length);
        SortedSetEntry member2 = unionWithScoreResults.First(r => r.Element == "member2");
    ...
    public async Task TestSortedSetLexCount(BaseClient client)
    {
        ...
        // Test full range
        long result = await client.SortedSetLexCountAsync(
            key,
            LexRange.Between(
                "a", "z"));
        ...
        // Test specific range
        result = await client.SortedSetLexCountAsync(
            key,
            LexRange.Between(
                "b", "d"));
    ...
    public async Task TestSortedSetBlockingPop(BaseClient client)
    {
        ...
        SortedSetEntry result = Assert.NotNull(await client.SortedSetPopMinAsync([key1], BlockingTimeout));
        ...
        Assert.Equal("member3", result.Element);
    ...
    public async Task TestSortedSetPopSingleKey(BaseClient client)
    {
        ...
        SortedSetEntry[] multiMinResult = await client.SortedSetPopMinAsync(key, 2);
    ...
    public async Task TestSortedSetRangeAndStore(BaseClient client)
    {
        ...
        result = await client.SortedSetRangeAndStoreAsync(
            sourceKey,
            destKey2,
            new()
            {
    ...
    public async Task TestSortedSetRemoveRangeByValue(BaseClient client)
    {
        ...
        Assert.Equal(
            0,
            await client.SortedSetRemoveRangeAsync(
                key,
        ...
        long result = await client.SortedSetRemoveRangeAsync(
            key,
    ...
    public async Task TestSortedSetUnion(BaseClient client)
    {
        ...
        // Test union with scores
        SortedSetEntry[] unionWithScores = await client.SortedSetUnionWithScoreAsync([key1, key2]);
        Assert.Equal(3, unionWithScores.Length);
        SortedSetEntry member2Entry = unionWithScores.First(r => r.Element == "member2");
