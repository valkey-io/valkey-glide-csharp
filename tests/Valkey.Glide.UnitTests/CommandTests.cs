...
public class CommandTests
{
    ...
    public void ValidateCommandConverters() => Assert.Multiple(
            ...
            () => Assert.Equal(30L, Request.KeyTimeToLiveAsync("key").Converter(30L)),
            () => Assert.Equal(-1L, Request.KeyTimeToLiveAsync("key").Converter(-1L)),
            () => Assert.Equal(-2L, Request.KeyTimeToLiveAsync("key").Converter(-2L)),
