...
public class CommandTests
{
    ...
    public void ValidateCommandArgs() => Assert.Multiple(
            ...
            () => Assert.Equal(["BITPOS", "key", "1", "0", "-1"], Request.BitPosAsync("key", true, 0, -1, StringIndexType.Byte).GetArgs()),
            () => Assert.Equal(["BITPOS", "key", "0", "2", "10", "BIT"], Request.BitPosAsync("key", false, 2, 10, StringIndexType.Bit).GetArgs()),
    ...
    public void ValidateCommandConverters() => Assert.Multiple(
            ...
            () => Assert.Equal(2L, Request.BitPosAsync("key", true, 0, -1, StringIndexType.Byte).Converter(2L)),
            () => Assert.Equal(-1L, Request.BitPosAsync("key", true, 0, -1, StringIndexType.Byte).Converter(-1L)),
