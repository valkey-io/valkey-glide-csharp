...
public class CommandTests
{
    ...
    public void ValidateCommandArgs() => Assert.Multiple(
            ...
            () => Assert.Equal(["HEXPIRE", "key", "60", "FIELDS", "2", "field1", "field2"], Request.HashExpireAsync("key", TimeSpan.FromSeconds(60), ["field1", "field2"], new HashFieldExpirationConditionOptions()).GetArgs()),
            () => Assert.Equal(["HEXPIRE", "key", "60", "NX", "FIELDS", "2", "field1", "field2"], Request.HashExpireAsync("key", TimeSpan.FromSeconds(60), ["field1", "field2"], new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.HasNoExpiry)).GetArgs()),
            () => Assert.Equal(["HEXPIRE", "key", "60", "XX", "FIELDS", "2", "field1", "field2"], Request.HashExpireAsync("key", TimeSpan.FromSeconds(60), ["field1", "field2"], new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.HasExistingExpiry)).GetArgs()),
            () => Assert.Equal(["HEXPIRE", "key", "60", "GT", "FIELDS", "2", "field1", "field2"], Request.HashExpireAsync("key", TimeSpan.FromSeconds(60), ["field1", "field2"], new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.NewExpiryGreaterThanCurrent)).GetArgs()),
            () => Assert.Equal(["HEXPIRE", "key", "60", "LT", "FIELDS", "2", "field1", "field2"], Request.HashExpireAsync("key", TimeSpan.FromSeconds(60), ["field1", "field2"], new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.NewExpiryLessThanCurrent)).GetArgs()),
            ...
            () => Assert.Equal(["HPEXPIRE", "key", "5500", "NX", "FIELDS", "2", "field1", "field2"], Request.HashExpireAsync("key", TimeSpan.FromMilliseconds(5500), ["field1", "field2"], new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.HasNoExpiry)).GetArgs()),
            () => Assert.Equal(["HEXPIREAT", "key", "1609459200", "FIELDS", "2", "field1", "field2"], Request.HashExpireAtAsync("key", DateTimeOffset.FromUnixTimeSeconds(1609459200), ["field1", "field2"], new HashFieldExpirationConditionOptions()).GetArgs()),
            () => Assert.Equal(["HEXPIREAT", "key", "1609459200", "NX", "FIELDS", "2", "field1", "field2"], Request.HashExpireAtAsync("key", DateTimeOffset.FromUnixTimeSeconds(1609459200), ["field1", "field2"], new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.HasNoExpiry)).GetArgs()),
            ...
            () => Assert.Equal(["HPEXPIREAT", "key", "1609459200500", "NX", "FIELDS", "2", "field1", "field2"], Request.HashExpireAtAsync("key", DateTimeOffset.FromUnixTimeMilliseconds(1609459200500), ["field1", "field2"], new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.HasNoExpiry)).GetArgs()),
    ...
    public void ValidateCommandConverters() => Assert.Multiple(
            ...
            () => Assert.Equal([1L, 0L, -2L], Request.HashExpireAsync("key", TimeSpan.FromMilliseconds(5000), ["field1", "field2", "field3"], new HashFieldExpirationConditionOptions()).Converter([1L, 0L, -2L])),
            ...
            () => Assert.Equal([1L, 0L, -2L], Request.HashExpireAtAsync("key", DateTimeOffset.FromUnixTimeMilliseconds(1609459200000), ["field1", "field2", "field3"], new HashFieldExpirationConditionOptions()).Converter([1L, 0L, -2L])),
