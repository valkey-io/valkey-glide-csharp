...
public class CommandTests
{
    ...
    public void ValidateCommandArgs() => Assert.Multiple(
            ...
            () => Assert.Equal(["PEXPIRE", "key", "60000", "NX"], Request.ExpireAsync("key", TimeSpan.FromSeconds(60), ExpireWhen.HasNoExpiry).GetArgs()),
            () => Assert.Equal(["PEXPIREAT", "key", "1609459200000"], Request.ExpireAsync("key", new DateTime(2021, 1, 1, 0, 0, 0, DateTimeKind.Utc)).GetArgs()),
            ...
            () => Assert.Equal(["RENAMENX", "oldkey", "newkey"], Request.RenameNXAsync("oldkey", "newkey").GetArgs()),
            ...
            () => Assert.Equal(["RESTORE", "key", "0", "data", "ABSTTL"], Request.RestoreDateTimeAsync("key", "data"u8.ToArray()).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "5000", "data"], Request.RestoreAsync("key", "data"u8.ToArray(), TimeSpan.FromSeconds(5)).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "2303596800000", "data", "ABSTTL"], Request.RestoreDateTimeAsync("key", "data"u8.ToArray(), new DateTime(2042, 12, 31, 0, 0, 0, DateTimeKind.Utc)).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "0", "data", "REPLACE"], Request.RestoreAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions().Replace()).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "0", "data", "IDLETIME", "1000"], Request.RestoreAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions().SetIdletime(1000)).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "0", "data", "FREQ", "5"], Request.RestoreAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions().SetFrequency(5)).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "0", "data", "REPLACE", "IDLETIME", "2000"], Request.RestoreAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions().Replace().SetIdletime(2000)).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "0", "data", "REPLACE", "FREQ", "10"], Request.RestoreAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions().Replace().SetFrequency(10)).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "0", "data", "ABSTTL"], Request.RestoreDateTimeAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions()).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "0", "data", "ABSTTL", "IDLETIME", "2000"], Request.RestoreDateTimeAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions().SetIdletime(2000)).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "0", "data", "ABSTTL", "FREQ", "10"], Request.RestoreDateTimeAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions().SetFrequency(10)).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "0", "data", "ABSTTL", "REPLACE", "IDLETIME", "3000"], Request.RestoreDateTimeAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions().Replace().SetIdletime(3000)).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "0", "data", "ABSTTL", "REPLACE", "FREQ", "20"], Request.RestoreDateTimeAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions().Replace().SetFrequency(20)).GetArgs()),
            () => Assert.Equal(["RESTORE", "key", "2303596800000", "data", "ABSTTL", "REPLACE"], Request.RestoreDateTimeAsync("key", "data"u8.ToArray(), new DateTime(2042, 12, 31, 0, 0, 0, DateTimeKind.Utc), new RestoreOptions().Replace()).GetArgs()),
            () => Assert.Throws<ArgumentException>(() => Request.RestoreAsync("key", "data"u8.ToArray(), restoreOptions: new RestoreOptions().SetIdletime(1000).SetFrequency(5)).GetArgs()),
    ...
    public void ValidateCommandConverters() => Assert.Multiple(
            ...
            () => Assert.Equal(30L, Request.TimeToLiveAsync("key").Converter(30L)),
            () => Assert.Equal(-1L, Request.TimeToLiveAsync("key").Converter(-1L)),
            () => Assert.Equal(-2L, Request.TimeToLiveAsync("key").Converter(-2L)),
            ...
            () => Assert.True(Request.RenameNXAsync("oldkey", "newkey").Converter(true)),
            () => Assert.False(Request.RenameNXAsync("oldkey", "newkey").Converter(false)),
            ...
            () => Assert.Equal(ValkeyValue.Ok, Request.RestoreDateTimeAsync("key", []).Converter("OK")),
            ...
            () => Assert.Equal(new DateTime(2021, 1, 1, 0, 0, 0, DateTimeKind.Utc), Request.ExpireTimeAsync("key").Converter(1609459200000L)),
