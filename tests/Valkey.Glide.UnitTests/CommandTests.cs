...
public class CommandTests
{
    ...
    public void ValidateCommandArgs()
    {
        Assert.Multiple(
            ...
            () => Assert.Equal(new string[] { "HEXPIRE", "key", "60", "NX", "FIELDS", "2", "field1", "field2" }, Request.HashExpireAsync("key", 60, new ValkeyValue[] { "field1", "field2" }, new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.HAS_NO_EXPIRY)).GetArgs()),
            () => Assert.Equal(new string[] { "HEXPIRE", "key", "60", "XX", "FIELDS", "2", "field1", "field2" }, Request.HashExpireAsync("key", 60, new ValkeyValue[] { "field1", "field2" }, new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.HAS_EXISTING_EXPIRY)).GetArgs()),
            () => Assert.Equal(new string[] { "HEXPIRE", "key", "60", "GT", "FIELDS", "2", "field1", "field2" }, Request.HashExpireAsync("key", 60, new ValkeyValue[] { "field1", "field2" }, new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.NEW_EXPIRY_GREATER_THAN_CURRENT)).GetArgs()),
            () => Assert.Equal(new string[] { "HEXPIRE", "key", "60", "LT", "FIELDS", "2", "field1", "field2" }, Request.HashExpireAsync("key", 60, new ValkeyValue[] { "field1", "field2" }, new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.NEW_EXPIRY_LESS_THAN_CURRENT)).GetArgs()),
            ...
            () => Assert.Equal(new string[] { "HPEXPIRE", "key", "5000", "NX", "FIELDS", "2", "field1", "field2" }, Request.HashPExpireAsync("key", 5000, new ValkeyValue[] { "field1", "field2" }, new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.HAS_NO_EXPIRY)).GetArgs()),
            ...
            () => Assert.Equal(new string[] { "HEXPIREAT", "key", "1609459200", "NX", "FIELDS", "2", "field1", "field2" }, Request.HashExpireAtAsync("key", 1609459200, new ValkeyValue[] { "field1", "field2" }, new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.HAS_NO_EXPIRY)).GetArgs()),
            ...
            () => Assert.Equal(new string[] { "HPEXPIREAT", "key", "1609459200000", "NX", "FIELDS", "2", "field1", "field2" }, Request.HashPExpireAtAsync("key", 1609459200000, new ValkeyValue[] { "field1", "field2" }, new HashFieldExpirationConditionOptions().SetCondition(ExpireOptions.HAS_NO_EXPIRY)).GetArgs()),
