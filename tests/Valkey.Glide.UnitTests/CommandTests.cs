...
public class CommandTests
{
    ...
    public void ValidateCommandArgs() => Assert.Multiple(
            ...
            () => Assert.Equal(["HSETEX", "key", "PX", "60000", "FIELDS", "2", "field1", "value1", "field2", "value2"], Request.HashSetExpiryAsync("key", new KeyValuePair<ValkeyValue, ValkeyValue>[] { new("field1", "value1"), new("field2", "value2") }, SetExpiryOptions.ExpireIn(TimeSpan.FromSeconds(60)), HashSetCondition.Always).GetArgs()),
            () => Assert.Equal(["HSETEX", "key", "PX", "5000", "FIELDS", "1", "field1", "value1"], Request.HashSetExpiryAsync("key", new KeyValuePair<ValkeyValue, ValkeyValue>[] { new("field1", "value1") }, SetExpiryOptions.ExpireIn(TimeSpan.FromMilliseconds(5000)), HashSetCondition.Always).GetArgs()),
            () => Assert.Equal(["HSETEX", "key", "PXAT", "60000", "FIELDS", "2", "field1", "value1", "field2", "value2"], Request.HashSetExpiryAsync("key", new KeyValuePair<ValkeyValue, ValkeyValue>[] { new("field1", "value1"), new("field2", "value2") }, SetExpiryOptions.ExpireAt(DateTimeOffset.FromUnixTimeMilliseconds(60000)), HashSetCondition.Always).GetArgs()),
            () => Assert.Equal(["HSETEX", "key", "PXAT", "5000", "FIELDS", "1", "field1", "value1"], Request.HashSetExpiryAsync("key", new KeyValuePair<ValkeyValue, ValkeyValue>[] { new("field1", "value1") }, SetExpiryOptions.ExpireAt(DateTimeOffset.FromUnixTimeMilliseconds(5000)), HashSetCondition.Always).GetArgs()),
            () => Assert.Equal(["HSETEX", "key", "KEEPTTL", "FIELDS", "1", "field1", "value1"], Request.HashSetExpiryAsync("key", new KeyValuePair<ValkeyValue, ValkeyValue>[] { new("field1", "value1") }, SetExpiryOptions.KeepTimeToLive(), HashSetCondition.Always).GetArgs()),
            () => Assert.Equal(["HSETEX", "key", "FNX", "PX", "60000", "FIELDS", "1", "field1", "value1"], Request.HashSetExpiryAsync("key", new KeyValuePair<ValkeyValue, ValkeyValue>[] { new("field1", "value1") }, SetExpiryOptions.ExpireIn(TimeSpan.FromSeconds(60)), HashSetCondition.OnlyIfNoneExist).GetArgs()),
            () => Assert.Equal(["HSETEX", "key", "FXX", "PX", "60000", "FIELDS", "1", "field1", "value1"], Request.HashSetExpiryAsync("key", new KeyValuePair<ValkeyValue, ValkeyValue>[] { new("field1", "value1") }, SetExpiryOptions.ExpireIn(TimeSpan.FromSeconds(60)), HashSetCondition.OnlyIfAllExist).GetArgs()),
    ...
    public void ValidateCommandConverters() => Assert.Multiple(
            ...
            () => Assert.Equal(new ValkeyValue[] { "value1", "value2" }, Request.HashGetExpiryAsync("key", ["field1", "field2"], GetExpiryOptions.ExpireIn(TimeSpan.FromSeconds(60))).Converter([(gs)"value1", (gs)"value2"])),
            () => Assert.Equal(new ValkeyValue[] { ValkeyValue.Null }, Request.HashGetExpiryAsync("key", ["field1"], GetExpiryOptions.Persist()).Converter([null!])),
            () => Assert.True(Request.HashSetExpiryAsync("key", new KeyValuePair<ValkeyValue, ValkeyValue>[] { new("field1", "value1") }, SetExpiryOptions.ExpireIn(TimeSpan.FromSeconds(60)), HashSetCondition.Always).Converter(1L)),
            () => Assert.False(Request.HashSetExpiryAsync("key", new KeyValuePair<ValkeyValue, ValkeyValue>[] { new("field1", "value1") }, SetExpiryOptions.ExpireIn(TimeSpan.FromSeconds(60)), HashSetCondition.Always).Converter(0L)),
