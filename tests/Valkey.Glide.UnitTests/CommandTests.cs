...
public class CommandTests
{
    ...
    public void ValidateCommandArgs()
    {
        Assert.Multiple(
            ...
            () => Assert.Equal(new string[] { "HSCAN", "key", "0" }, Request.HashScanAsync("key", 0, ValkeyValue.Null, 0).GetArgs()),
            () => Assert.Equal(new string[] { "HSCAN", "key", "0", "MATCH", "pattern*", "COUNT", "10" }, Request.HashScanAsync("key", 0, "pattern*", 10).GetArgs()),
            () => Assert.Equal(new string[] { "HSCAN", "key", "0" }, Request.HashScanNoValuesAsync("key", 0, ValkeyValue.Null, 0).GetArgs()),
            () => Assert.Equal(new string[] { "HSCAN", "key", "0", "MATCH", "pattern*", "COUNT", "10" }, Request.HashScanNoValuesAsync("key", 0, "pattern*", 10).GetArgs()),
