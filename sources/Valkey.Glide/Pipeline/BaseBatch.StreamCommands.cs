...
public abstract partial class BaseBatch<T> where T : BaseBatch<T>
{
    ...
    public T StreamAcknowledge(ValkeyKey key, ValkeyValue groupName, ValkeyValue messageId) =>
        AddCmd(Request.StreamAcknowledgeAsync(key, groupName, messageId));
    ...
    public T StreamAcknowledge(ValkeyKey key, ValkeyValue groupName, IEnumerable<ValkeyValue> messageIds) =>
        AddCmd(Request.StreamAcknowledgeAsync(key, groupName, [.. messageIds]));
    ...
    /// <inheritdoc cref="IBatchStreamCommands.StreamAutoClaim(ValkeyKey, ValkeyValue, ValkeyValue, Commands.Options.StreamAutoClaimOptions)" />
    public T StreamAutoClaim(ValkeyKey key, ValkeyValue consumerGroup, ValkeyValue claimingConsumer, StreamAutoClaimOptions options) =>
        AddCmd(Request.StreamAutoClaimAsync(key, consumerGroup, claimingConsumer, options));

    #endregion
    #region StreamAutoClaimJustId

    /// <inheritdoc cref="IBatchStreamCommands.StreamAutoClaimJustId(ValkeyKey, ValkeyValue, ValkeyValue, Commands.Options.StreamAutoClaimOptions)" />
    public T StreamAutoClaimJustId(ValkeyKey key, ValkeyValue consumerGroup, ValkeyValue claimingConsumer, StreamAutoClaimOptions options) =>
        AddCmd(Request.StreamAutoClaimJustIdAsync(key, consumerGroup, claimingConsumer, options));

    #endregion
    #region StreamClaim

    /// <inheritdoc cref="IBatchStreamCommands.StreamClaim(ValkeyKey, ValkeyValue, ValkeyValue, ValkeyValue, Commands.Options.StreamClaimOptions)" />
    public T StreamClaim(ValkeyKey key, ValkeyValue consumerGroup, ValkeyValue claimingConsumer, ValkeyValue messageId, StreamClaimOptions options) =>
        StreamClaim(key, consumerGroup, claimingConsumer, [messageId], options);

    /// <inheritdoc cref="IBatchStreamCommands.StreamClaim(ValkeyKey, ValkeyValue, ValkeyValue, IEnumerable{ValkeyValue}, Commands.Options.StreamClaimOptions)" />
    public T StreamClaim(ValkeyKey key, ValkeyValue consumerGroup, ValkeyValue claimingConsumer, IEnumerable<ValkeyValue> messageIds, StreamClaimOptions options) =>
        AddCmd(Request.StreamClaimAsync(key, consumerGroup, claimingConsumer, messageIds, options));

    #endregion
    #region StreamClaimJustId

    /// <inheritdoc cref="IBatchStreamCommands.StreamClaimJustId(ValkeyKey, ValkeyValue, ValkeyValue, ValkeyValue, Commands.Options.StreamClaimOptions)" />
    public T StreamClaimJustId(ValkeyKey key, ValkeyValue consumerGroup, ValkeyValue claimingConsumer, ValkeyValue messageId, StreamClaimOptions options) =>
        StreamClaimJustId(key, consumerGroup, claimingConsumer, [messageId], options);

    /// <inheritdoc cref="IBatchStreamCommands.StreamClaimJustId(ValkeyKey, ValkeyValue, ValkeyValue, IEnumerable{ValkeyValue}, Commands.Options.StreamClaimOptions)" />
    public T StreamClaimJustId(ValkeyKey key, ValkeyValue consumerGroup, ValkeyValue claimingConsumer, IEnumerable<ValkeyValue> messageIds, StreamClaimOptions options) =>
        AddCmd(Request.StreamClaimIdsOnlyAsync(key, consumerGroup, claimingConsumer, messageIds, options));
    ...
    public T StreamGroupCreate(ValkeyKey key, ValkeyValue groupName, ValkeyValue position) =>
        StreamGroupCreate(key, groupName, position, new StreamGroupCreateOptions());
    ...
    public T StreamGroupCreate(ValkeyKey key, ValkeyValue groupName, ValkeyValue position, StreamGroupCreateOptions options) =>
        AddCmd(Request.StreamGroupCreateAsync(key, groupName, position, options));
    ...
    public T StreamGroupCreateConsumer(ValkeyKey key, ValkeyValue groupName, ValkeyValue consumerName) =>
        AddCmd(Request.StreamGroupCreateConsumerAsync(key, groupName, consumerName));
    ...
    public T StreamGroupDeleteConsumer(ValkeyKey key, ValkeyValue groupName, ValkeyValue consumerName) =>
        AddCmd(Request.StreamGroupDeleteConsumerAsync(key, groupName, consumerName));
    ...
    public T StreamGroupDestroy(ValkeyKey key, ValkeyValue groupName) =>
        AddCmd(Request.StreamGroupDestroyAsync(key, groupName));
    ...
    public T StreamGroupSetId(ValkeyKey key, ValkeyValue groupName, ValkeyValue position) =>
        AddCmd(Request.StreamGroupSetIdAsync(key, groupName, position, null));
    ...
    public T StreamGroupSetId(ValkeyKey key, ValkeyValue groupName, ValkeyValue position, long entriesRead) =>
        AddCmd(Request.StreamGroupSetIdAsync(key, groupName, position, entriesRead));
    ...
    public T StreamInfoConsumers(ValkeyKey key, ValkeyValue groupName) => AddCmd(Request.StreamInfoConsumersAsync(key, groupName));

    #endregion
    #region StreamInfoFull

    /// <inheritdoc cref="IBatchStreamCommands.StreamInfoFull(ValkeyKey)" />
    public T StreamInfoFull(ValkeyKey key) => AddCmd(Request.StreamInfoFullAsync(key, null));

    /// <inheritdoc cref="IBatchStreamCommands.StreamInfoFull(ValkeyKey, int)" />
    public T StreamInfoFull(ValkeyKey key, int count) => AddCmd(Request.StreamInfoFullAsync(key, count));

    #endregion
    #region StreamInfoGroups

    /// <inheritdoc cref="IBatchStreamCommands.StreamInfoGroups(ValkeyKey)" />
    public T StreamInfoGroups(ValkeyKey key) => AddCmd(Request.StreamInfoGroupsAsync(key));
    ...
    public T StreamPending(ValkeyKey key, ValkeyValue groupName) =>
        AddCmd(Request.StreamPendingAsync(key, groupName));
    ...
    public T StreamPending(ValkeyKey key, ValkeyValue groupName, StreamPendingOptions options) =>
        AddCmd(Request.StreamPendingMessagesAsync(key, groupName, options.Start.Value, options.End.Value, options.Count, options.ConsumerName, options.MinIdleTime));
    ...
    public T StreamTrim(ValkeyKey key, StreamTrimOptions options) => AddCmd(Request.StreamTrimAsync(key, options));
