...
public abstract partial class BaseBatch<T> where T : BaseBatch<T>
{
    ...
    /// <inheritdoc cref="IBatchStreamCommands.StreamCreateConsumerGroup(ValkeyKey, ValkeyValue, ValkeyValue?, bool)" />
    public T StreamCreateConsumerGroup(ValkeyKey key, ValkeyValue groupName, ValkeyValue? position = null, bool createStream = true) =>
        AddCmd(Request.StreamCreateConsumerGroupAsync(key, groupName, position ?? default, createStream));
    ...
    /// <inheritdoc cref="IBatchStreamCommands.StreamConsumerGroupSetPosition(ValkeyKey, ValkeyValue, ValkeyValue)" />
    public T StreamConsumerGroupSetPosition(ValkeyKey key, ValkeyValue groupName, ValkeyValue position) => AddCmd(Request.StreamConsumerGroupSetPositionAsync(key, groupName, position));
    ...
    IBatch IBatchStreamCommands.StreamCreateConsumerGroup(ValkeyKey key, ValkeyValue groupName, ValkeyValue? position, bool createStream) => StreamCreateConsumerGroup(key, groupName, position, createStream);
    ...
    IBatch IBatchStreamCommands.StreamConsumerGroupSetPosition(ValkeyKey key, ValkeyValue groupName, ValkeyValue position) => StreamConsumerGroupSetPosition(key, groupName, position);
