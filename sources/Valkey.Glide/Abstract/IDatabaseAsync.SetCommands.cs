...
/// <summary>
/// Set commands for StackExchange.Redis databases.
/// </summary>
...
public partial interface IDatabaseAsync
{
    ...
    /// await db.SetAddAsync("set2", ["b", "c", "d"]);
    ...
    /// await foreach (var member in db.SetScanAsync("myset", pattern: "ap*"))
    /// {
