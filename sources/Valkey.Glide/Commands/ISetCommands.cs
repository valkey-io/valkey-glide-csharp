...
public interface ISetCommands
{
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetMembersAsync(ValkeyKey key);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetLengthAsync(ValkeyKey key);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetIntersectionLengthAsync(IEnumerable<ValkeyKey> keys, long limit = 0);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetUnionAsync(ValkeyKey first, ValkeyKey second);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetUnionAsync(IEnumerable<ValkeyKey> keys);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetIntersectAsync(ValkeyKey first, ValkeyKey second);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetIntersectAsync(IEnumerable<ValkeyKey> keys);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetDifferenceAsync(ValkeyKey first, ValkeyKey second);
    ...
    /// </example>
    /// </remarks>
    Task<ValkeyValue[]> SetDifferenceAsync(IEnumerable<ValkeyKey> keys);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetUnionStoreAsync(ValkeyKey destination, ValkeyKey first, ValkeyKey second);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetIntersectStoreAsync(ValkeyKey destination, ValkeyKey first, ValkeyKey second);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetIntersectStoreAsync(ValkeyKey destination, IEnumerable<ValkeyKey> keys);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetDifferenceStoreAsync(ValkeyKey destination, ValkeyKey first, ValkeyKey second);
    ...
    /// </example>
    /// </remarks>
    Task<long> SetDifferenceStoreAsync(ValkeyKey destination, IEnumerable<ValkeyKey> keys);
    ...
    /// </example>
    /// </remarks>
    Task<bool> SetContainsAsync(ValkeyKey key, ValkeyValue value);
    ...
    /// </example>
    /// </remarks>
    Task<bool[]> SetContainsAsync(ValkeyKey key, IEnumerable<ValkeyValue> values);
