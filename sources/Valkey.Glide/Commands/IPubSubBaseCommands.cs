...
public interface IPubSubBaseCommands
{
    ...
    /// <param name="timeout">Maximum time to wait for server confirmation. Use <see cref="TimeSpan.Zero"/> to wait indefinitely.</param>
    ...
    abstract Task SubscribeAsync(string channel, TimeSpan timeout);
    ...
    /// <exception cref="ArgumentException">Thrown if timeout is negative.</exception>
    /// <exception cref="Errors.TimeoutException">Thrown if server confirmation is not received within the specified timeout.</exception>
    abstract Task SubscribeAsync(IEnumerable<string> channels, TimeSpan timeout);
    ...
    /// <exception cref="ArgumentException">Thrown if timeout is negative.</exception>
    /// <exception cref="Errors.TimeoutException">Thrown if server confirmation is not received within the specified timeout.</exception>
    abstract Task PSubscribeAsync(string pattern, TimeSpan timeout);
    ...
    /// <exception cref="ArgumentException">Thrown if timeout is negative.</exception>
    /// <exception cref="Errors.TimeoutException">Thrown if server confirmation is not received within the specified timeout.</exception>
    abstract Task PSubscribeAsync(IEnumerable<string> patterns, TimeSpan timeout);

    /// <summary>
    /// Subscribes the client to the specified pattern and returns without waiting for server confirmation.
    /// <para />
    /// The client will attempt to subscribe asynchronously in the background.
    /// Use <see cref="GetSubscriptionsAsync"/> to verify the
    ...
    /// <exception cref="ArgumentException">Thrown if timeout is negative.</exception>
    /// <exception cref="Errors.TimeoutException">Thrown if server confirmation is not received within the specified timeout.</exception>
    abstract Task UnsubscribeAsync(string channel, TimeSpan timeout);
    ...
    /// <exception cref="ArgumentException">Thrown if timeout is negative.</exception>
    /// <exception cref="Errors.TimeoutException">Thrown if server confirmation is not received within the specified timeout.</exception>
    abstract Task UnsubscribeAsync(IEnumerable<string> channels, TimeSpan timeout);
    ...
    /// <exception cref="ArgumentException">Thrown if timeout is negative.</exception>
    /// <exception cref="Errors.TimeoutException">Thrown if server confirmation is not received within the specified timeout.</exception>
    abstract Task PUnsubscribeAsync(string pattern, TimeSpan timeout);
    ...
    /// <exception cref="ArgumentException">Thrown if timeout is negative.</exception>
    /// <exception cref="Errors.TimeoutException">Thrown if server confirmation is not received within the specified timeout.</exception>
    abstract Task PUnsubscribeAsync(IEnumerable<string> patterns, TimeSpan timeout);
