...
public static class Constants
{
    ...
    /// <summary>
    /// Keywords for Vector Search (FT.*) commands.
    /// </summary>
    public const string SchemaKeyword = "SCHEMA";
    public const string OnKeyword = "ON";
    public const string PrefixKeyword = "PREFIX";
    public const string ScoreKeyword = "SCORE";
    public const string LanguageKeyword = "LANGUAGE";
    public const string SkipInitialScanKeyword = "SKIPINITIALSCAN";
    public const string MinStemSizeKeyword = "MINSTEMSIZE";
    public const string WithOffsetsKeyword = "WITHOFFSETS";
    public const string NoOffsetsKeyword = "NOOFFSETS";
    public const string NoStopWordsKeyword = "NOSTOPWORDS";
    public const string StopWordsKeyword = "STOPWORDS";
    public const string PunctuationKeyword = "PUNCTUATION";
    public const string AsKeyword = "AS";
    public const string NoStemKeyword = "NOSTEM";
    public const string WeightKeyword = "WEIGHT";
    public const string WithSuffixTrieKeyword = "WITHSUFFIXTRIE";
    public const string NoSuffixTrieKeyword = "NOSUFFIXTRIE";
    public const string SortableKeyword = "SORTABLE";
    public const string SeparatorKeyword = "SEPARATOR";
    public const string CaseSensitiveKeyword = "CASESENSITIVE";
    public const string NoContentKeyword = "NOCONTENT";
    public const string VerbatimKeyword = "VERBATIM";
    public const string InOrderKeyword = "INORDER";
    public const string SlopKeyword = "SLOP";
    public const string ReturnKeyword = "RETURN";
    public const string SortByKeyword = "SORTBY";
    public const string WithSortKeysKeyword = "WITHSORTKEYS";
    public const string TimeoutKeyword = "TIMEOUT";
    public const string ParamsKeyword = "PARAMS";
    public const string DialectKeyword = "DIALECT";
    public const string LoadKeyword = "LOAD";
    public const string FilterKeyword = "FILTER";
    public const string ReduceKeyword = "REDUCE";
    public const string GroupByKeyword = "GROUPBY";
    public const string ApplyKeyword = "APPLY";
    public const string AllShardsKeyword = "ALLSHARDS";
    public const string SomeShardsKeyword = "SOMESHARDS";
    public const string ConsistentKeyword = "CONSISTENT";
    public const string InconsistentKeyword = "INCONSISTENT";
    public const string LocalKeyword = "LOCAL";
    public const string PrimaryKeyword = "PRIMARY";
    public const string ClusterKeyword = "CLUSTER";
}
